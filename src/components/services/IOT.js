...
import iotService1 from '../../assests/servicesPage/iotHero.jfif';
import iotService2 from '../../assests/servicesPage/iotService2.png';
    ...
    <div className='flex justify-between bg-scroll font-rubik'>
      <div className='relative w-full h-screen'>
        <div className='absolute left-1/3 top-1/2'>
          <img src={iotService2} alt='' />
        </div>
        <img src={iotService1} alt='' className='h-full' />
      </div>

      <div className='container mt-24'>
        <h1 className='mb-12 text-3xl font-bold leading-relaxed lg:text-4xl text-text-primary lg:leading-relaxed'>
          <span className='text-text-brand'>Building the Future With IoT</span>{' '}
